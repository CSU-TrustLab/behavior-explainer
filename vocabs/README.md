...
- **`prompts.txt`** — A set of prompt templates (e.g., `a photo of a {}.`) used to obtain concept vectors via CLIP's text encoder, following the prompt-engineering approach introduced in [Radford et al. (2021)](https://arxiv.org/abs/2103.00020).
